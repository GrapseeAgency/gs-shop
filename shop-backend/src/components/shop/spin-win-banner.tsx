        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between gap-3">
            <div className="flex-1">
              ...
              {lastPrize && (
                <motion.p
                  className="mt-1.5 inline-flex items-center gap-1 rounded-full bg-white/15 px-2 py-0.5 text-[10px] font-medium text-white/90 backdrop-blur-sm"
            ...
            >
              <Button
                onClick={() => goSpinWin()}
                className="bg-white text-purple-700 hover:bg-white/90 shadow-md font-bold text-sm px-4 gap-1.5 active:scale-95 transition-transform"
              >
                Spin Now
