      ...
      <section className="mb-5">
        ...
        <div className="rounded-xl border border-border/50 bg-card p-3">
          <div className="flex items-center justify-between">
            ...
            >
              <div className={`absolute top-0.5 h-5 w-5 rounded-full bg-glass-deep shadow-sm transition-transform ${darkMode ? 'translate-x-5.5' : 'translate-x-0.5'}`} />
            </button>
          </div>
          {/* Theme Preview */}
...
function SettingToggle({
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border border-border/50 bg-card p-3">
      ...
      >
        <div className={`absolute top-0.5 h-5 w-5 rounded-full bg-glass-deep shadow-sm transition-transform ${enabled ? 'translate-x-5.5' : 'translate-x-0.5'}`} />
      </button>
    </div>
  )
}
