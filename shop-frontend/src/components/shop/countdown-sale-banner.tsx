...
function FlipDigit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <div className="relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-xl bg-glass-deep/20 backdrop-blur-md border border-white/10 shadow-lg">
        {/* Flip line */}
  ...
  return (
    <section className="px-4 py-4">
      ...
      >
        ...
        <div className="absolute -left-4 bottom-0 h-24 w-24 rounded-full bg-glass-deep/10 blur-xl" />

        {/* Content */}
        <div className="relative z-10 px-5 py-5">
          {/* Badge */}
          <div className="mb-3 inline-flex items-center gap-1.5 rounded-full bg-glass-deep/20 px-3 py-1 backdrop-blur-sm">
          ...
          <Button
            onClick={() => goDeals()}
            className="gap-2 bg-glass-deep text-red-600 hover:bg-glass-deep/90 font-bold shadow-xl shadow-black/20"
            size="lg"
          >
            Shop the Sale
