        ...
        {isFullscreen && (
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 w-10 h-10 rounded-full bg-glass-deep/10 flex items-center justify-center z-10"
            >
            ...
            >
              ...
              {validImages.length > 1 && (
                <>
                  <button
                    onClick={goToPrev}
                    className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-glass-deep/10 flex items-center justify-center"
                  >
                    <ChevronLeft className="w-5 h-5 text-white" />
                  </button>
                  <button
                    onClick={goToNext}
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-glass-deep/10 flex items-center justify-center"
                  >
            ...
            {/* Counter */}
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-glass-deep/10 text-white text-sm font-medium">
              {activeIndex + 1} / {validImages.length}
            </div>
          </motion.div>
        )}
