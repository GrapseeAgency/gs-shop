...
const []: StockProduct[] = [
  { id: '1', name: 'Wireless Earbuds Pro', price: 2999, imageUrl: null, category: 'Electronics', status: 'active', estimatedRestock: '2025-01-15', notifyEnabled: true },
  { id: '2', name: 'Smart Watch Ultra', price: 8999, imageUrl: null, category: 'Electronics', status: 'active', estimatedRestock: '2025-01-20', notifyEnabled: true },
  { id: '3', name: 'Gaming Headset RGB', price: 4499, imageUrl: null, category: 'Gaming', status: 'notified', estimatedRestock: '2025-01-10', notifyEnabled: false },
  { id: '4', name: 'Mechanical Keyboard', price: 5999, imageUrl: null, category: 'Gaming', status: 'active', estimatedRestock: '2025-02-01', notifyEnabled: true },
  { id: '5', name: 'USB-C Hub 7-in-1', price: 1999, imageUrl: null, category: 'Accessories', status: 'expired', estimatedRestock: '2024-12-25', notifyEnabled: false },
  { id: '6', name: 'Portable Charger 20000mAh', price: 2499, imageUrl: null, category: 'Accessories', status: 'active', estimatedRestock: '2025-01-25', notifyEnabled: true },
]
