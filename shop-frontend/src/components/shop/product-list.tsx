  ...
  if (loading) {
    return (
      <div className="space-y-3">
        ...
        <div className={`grid gap-3 ${viewMode === 'grid' ? 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6' : 'grid-cols-1'}`}>
  ...
  if (products.length === 0) {
    return (
      ...
      >
        ...
        {activeFilterCount > 0 && (
            <Button variant="outline" size="sm" className="mt-3 gap-1.5 text-sm" onClick={resetFilters}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button
            variant="outline"
            size="sm"
            className="h-8 gap-1.5 text-sm px-3 relative"
