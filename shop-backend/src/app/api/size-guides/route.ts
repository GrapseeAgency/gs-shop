...
const sizeGuides: Record<string, {
  ...
  clothing: {
    ...
    howToMeasure: [
      ...
      { step: 'Length', detail: 'Measure from the highest point of the shoulder down to the hem.' },
    ],
  },
  shoes: {
    ...
    howToMeasure: [
      ...
      { step: 'Tip', detail: 'Measure in the afternoon when feet are slightly larger. Wear the socks you intend to use.' },
    ],
  },
  accessories: {
    ...
    howToMeasure: [
      { step: 'Ring', detail: 'Wrap a strip of paper around your finger, mark the overlap, and measure the length in mm.' },
      { step: 'Belt', detail: 'Measure around your waist where you normally wear your belt, or measure an existing belt from buckle to the hole you use.' },
      { step: 'Bracelet', detail: 'Measure around your wrist with a flexible tape, then add 1-2 cm for comfort.' },
    ],
  },
}
