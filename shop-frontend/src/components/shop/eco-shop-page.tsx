            ...
            {filteredProducts.map((product, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Image */}
                  <div className="w-full cursor-pointer" onClick={() => goProduct(product.productId)}>
                  ...
                  <div className="p-2.5">
                    <div onClick={() => goProduct(product.productId)} className="w-full text-left cursor-pointer">
