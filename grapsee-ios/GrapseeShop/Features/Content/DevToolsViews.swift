    ...
    var body: some View {
        List(guides) { g in
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("\(g.pages) pages · \(g.sales) sold · ⭐ \(g.rating, specifier: "%.1f")").font(.caption).foregroundColor(.secondary)
    ...
    var body: some View {
        List(notionTpls) { t in
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("\(t.pages) pages · \(t.sales) sold · ⭐ \(t.rating, specifier: "%.1f")").font(.caption).foregroundColor(.secondary)
                Text(t.desc).font(.caption).foregroundColor(.secondary)
    ...
    var body: some View {
        List(tutorials) { t in
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("\(t.duration) · \(t.views) views · ⭐ \(t.rating, specifier: "%.1f")").font(.caption).foregroundColor(.secondary)
