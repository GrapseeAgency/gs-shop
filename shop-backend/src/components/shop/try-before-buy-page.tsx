...
const []: TrialProduct[] = [
  { id: '1', name: 'Premium Wireless Headphones', price: 4999, imageUrl: null, category: 'Electronics', rating: 4.8, trialDays: 7 },
  { id: '2', name: 'Ergonomic Office Chair', price: 12999, imageUrl: null, category: 'Home', rating: 4.6, trialDays: 7 },
  { id: '3', name: 'Smart Fitness Band', price: 2999, imageUrl: null, category: 'Wearables', rating: 4.5, trialDays: 7 },
  { id: '4', name: 'Portable Bluetooth Speaker', price: 3499, imageUrl: null, category: 'Electronics', rating: 4.7, trialDays: 7 },
  { id: '5', name: 'Memory Foam Pillow', price: 1999, imageUrl: null, category: 'Home', rating: 4.4, trialDays: 7 },
]
...
export function TryBeforeBuyPage() {
  ...
  const handleToggleTrial = (product: Product) => {
    if (isInTrial(product.id)) {
      removeFromTrial(product.id)
